        ...
        import { pickPriorityNutrient } from './recommend.js?v=0.7.15';
        import { mealTime, mealTypeForTime, snapTime, buildTimeline, DEFAULT_MEAL_TIME } from './timeline.js?v=0.7.15';
        import { topMealRanking, paginate, monthsInRange } from './stats.js?v=0.7.15';
        ...
        createApp({
            setup() {
                console.log('App initialization starting... v0.7.15');
                ...
                // 而且是營養素主欄位停用與否的唯一依據,收成一個具名條件比較好讀。
                const hasItems = computed(() => editingMeal.items && editingMeal.items.length > 0);
