        ...
        import { pickPriorityNutrient } from './recommend.js?v=0.6.5';
        import { mealTime, mealTypeForTime, snapTime, buildTimeline, DEFAULT_MEAL_TIME } from './timeline.js?v=0.6.5';
        import { topMealRanking, paginate, monthsInRange } from './stats.js?v=0.6.5';
        ...
        createApp({
            setup() {
                console.log('App initialization starting... v0.6.5');
